...
<body>
    <h1 style="text-align: center; color: rgb(26, 26, 26); font-size: 45px; text-shadow: 2px 2px 8px white;"><a href="/views/prop_list.jsp" class="fa fa-arrow-left back-arrow"></a>Rent Your Property</h1>
    <form action='/addProperty' class='form' enctype="multipart/form-data" method="post" >
    <input id='prop_type' name='prop_type' required type='hidden' value='Rent'>
