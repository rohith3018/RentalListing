  ...
  <section class="contact-us" id="contact-section">
    <form id="contact" action="/contact" method="post">
      <div class="section-heading">
        <h4><a href="/views/index.jsp" class="fa fa-arrow-left back-arrow"></a>Contact us</h4>
      </div>
    ...
    $(document).ready(function () {
      ...
      function validateName() {
        ...
        // check first character
          ...
          $(".valid_info_name")
            .text(
              "The name entered is invalid. The first character must be a letter"
            )
            .css("color", "red");
        ...
        // length check
          ...
          (0 < name.value.length && name.value.length < minLengthName) ||
          name.value.length > maxLengthName
        ) {
          $("#name").removeClass("valid");
          $("#name").removeClass("invalid");
          $(".valid_info_name")
            .text(
              "The name entered is invalid. The name must be between " +
              minLengthName +
              " and " +
              maxLengthName +
              " characters"
        ...
        // input validation no more than 3 identical characters in a row
          ...
          $(".valid_info_name")
            .text(
              "The name entered is invalid. Too many identical characters"
            )
            .css("color", "red");
          $("#name").addClass("invalid");
          nameVal = false;
        ...
        // checking for valid characters
          ...
          $(".valid_info_name")
            .text(
              "The name entered is invalid. The name can only contain letters, numbers, spaces and symbols (._-)"
            )
            .css("color", "red");
          $("#name").addClass("invalid");
          nameVal = false;
          ...
          if (!/[a-zA-Zа-яА-ЯёЁіІїЇєЄ]/.test(firstChar)) {
            ...
            $(".valid_info_name")
              .text(
                "The name entered invalid. The first character must be a letter"
              )
              .css("color", "red");
            $("#name").addClass("invalid");
            nameVal = false;
      ...
      $(document).ready(function () {
        $("#name").on("keypress", function (event) {
          ...
          if (
            valueName.length === 0 &&
            !/[a-zA-Zа-яА-ЯіІїЇєЄ]/.test(nameKey)
          ) {
        ...
        $("#email").on("keypress", function (event) {
          ...
          if (!regex.test(char)) {
            setTimeout(function () {
              ...
              $(".valid_info_email")
                .text(
                  "Latin letters, numbers and some symbols are allowed in this field"
                )
                .css("color", "red");
              setTimeout(function () {
                infoCallback();
      ...
      function validateEmail() {
        if (
          ...
          if (input.value.indexOf("@") !== -1) {
            ...
            if (atIndex >= 0) {
              ...
              if (/@.*?\.{2,}/.test(email)) {
                ...
                $(".valid_info_email")
                  .text(
                    "The address entered is invalid. Check the address you entered"
                  )
                  .css("color", "red");
              ...
              // check more than 2 dots after "@"
                ...
                $(".valid_info_email")
                  .text(
                    'The address entered is invalid. Too many dots after "@"'
                  )
                  .css("color", "red");
                $("#email").addClass("invalid");
                let infoCallback = function () {
              ...
              // check first char
                ...
                $(".valid_info_email")
                  .text(
                    "The address entered is invalid. The first character can only be a letter or a number"
                  )
                  .css("color", "red");
                $("#email").addClass("invalid");
                let infoCallback = function () {
              ...
              // check duplicates
                ...
                $(".valid_info_email")
                  .text(
                    "The address entered is invalid. Too many identical characters"
                  )
                  .css("color", "red");
                $("#email").addClass("invalid");
                let infoCallback = function () {
                ...
                if (emailRegEx.test($("#email").val())) {
                  ...
                  $("#email").removeClass("invalid");
                  $(".valid_info_email")
                    .text("The address entered is invalid")
                    .css("color", "red");
                  $("#email").addClass("invalid");
                  let infoCallback = function () {
                    $(".valid_info_email")
          ...
          // check duplicates
            ...
            $("#email").removeClass("invalid");
            $(".valid_info_email")
              .text('The entered address is invalid, please enter "@"')
              .css("color", "red");
            $("#email").addClass("invalid");
            let infoCallback = function () {
              $(".valid_info_email")
          ...
          if (
            (input.value.length > 0 && input.value.length < minLength) ||
            input.value.length > maxLength
          ) {
            $("#email").removeClass("valid");
            $("#email").removeClass("invalid");
            $(".valid_info_email")
              .text(
                "The address entered is invalid, valid from " +
                minLength +
                " to " +
                maxLength +
                " characters"
      ...
      function validateTextarea() {
        ...
        // if the field contains illegal characters
          ...
          $("#message").removeClass("invalid");
          $(".valid_info_message")
            .text("Invalid characters entered")
            .css("color", "red");
        ...
        // if the field contains more than 500 characters
          ...
          $("#message").removeClass("invalid");
          $(".valid_info_message")
            .text("The maximum message length is 500 characters")
            .css("color", "red");
          $("#message").addClass("invalid");
          textareaVal = false;
          return false;
